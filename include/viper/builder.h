...
vb_func *vb_func_native(vb_builder *builder, vp_native_func fn,
                        vp_type ret, vp_type *args, u8 num_args);

vb_inst *vb_inst_create(vb_block *block, int num_inst);
vb_block *vb_block_create(vb_func *fn, int size);
